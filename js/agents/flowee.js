...
class FloweeAgent {
    constructor() {
        ...
        this.dialogueMatrix = {
            ...
            "membership_plans": { mode: "guide", intro: "Membership — language, cinematic, then Bronze / Silver / Gold. Skip anytime; Log in or Register during the intro." },
            "membership": { mode: "guide", intro: "Membership — language, cinematic, then Bronze / Silver / Gold. Skip anytime; Log in or Register during the intro." },
            "admin_membership": { mode: "guide", intro: "Flow Control — I guide Impact, Members, Events and Invite. Unlock first, then follow my dock." },
