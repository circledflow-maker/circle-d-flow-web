...
window.SPHERE_WORLDS = {
    ...
    Vision: {
        ...
        destinations: [
            { l: 'VISION HUB', u: 'photographer_hub.html', icon: 'hub', desc: 'Solo + community paths' },
            ...
            { l: 'BOOK SESSION', u: 'booking.html', icon: 'event', desc: 'Photo session · Lisbon' },
        ],
    },
    Sound: {
        label: 'Sound',
    ...
    Taste: {
        ...
        destinations: [
            { l: 'TASTE HUB', u: 'taste_world_hub.html', icon: 'hub', desc: 'All taste paths' },
            { l: 'THE KITCHEN', u: 'akwaba_kitchen.html', icon: 'restaurant', desc: 'AkwabaLX @ Secret Garden' },
            { l: 'TASTE RADAR', u: 'taste_radar.html', icon: 'radar', desc: 'Swipe & order pickup' },
            { l: 'KITCHEN OPS', u: 'kitchen_workspace.html?kitchen=akwabalx', icon: 'skillet', desc: 'Chef command center' },
            { l: 'FLAVOR QUEST', u: 'flavor_quest.html', icon: 'local_dining', desc: 'Taste missions' },
            { l: 'TASTE GATE', u: 'taste_world_entry.html', icon: 'door_open', desc: 'Creator vs Guest' },
        ],
    },
    Connection: {
        label: 'Connection',
