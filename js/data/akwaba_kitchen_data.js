...
window.AKWABA_KITCHEN = {
  ...
  menu_board: '../Assets/kitchens/akwabalx/menu-board.jpg',
  ...
  gallery: [
    ...
    '../Assets/kitchens/akwabalx/menu-board.jpg',
    '../Assets/kitchens/akwabalx/dish-table-combo.jpg',
  ],
  ...
  menu: [
    { id: 'kitkat-special', name: 'KitKat Special', description: 'Chef signature — sweet heat fusion plate', category: 'main', price_eur: 14, image: '../Assets/kitchens/akwabalx/dish-kitkat-special.jpg' },
    { id: 'wings-plantain', name: 'Chicken Wings & Plantain', description: 'Crispy wings with sweet plantain combo', category: 'main', price_eur: 13, image: '../Assets/kitchens/akwabalx/dish-wings-plantain.jpg' },
    { id: 'table-combo', name: 'Akwaba Table Combo', description: 'Rice, stew & sides — best at the garden table', category: 'combo', price_eur: 16, image: '../Assets/kitchens/akwabalx/dish-table-combo.jpg' },
    { id: 'veggie-burger', name: 'Veggie Burger', description: 'Garden patty with fresh greens — ask at bar', category: 'vegan', price_eur: 12, image: '../Assets/kitchens/akwabalx/dish-veggie-burger.jpg' },
