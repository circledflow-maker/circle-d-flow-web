...
const FALLBACK_LOCATION = {
  ...
  name: 'Lapa71',
  slug: 'lapa71',
  description: 'Community space · music · movement · connection in Lisbon.',
  address: 'Lapa, Lisbon',
  city: 'Lisbon',
  latitude: 38.7139,
  longitude: -9.1603,
  ...
  website_url: null,
  map_url: 'https://maps.google.com/?q=Lapa+Lisbon',
  status: 'active',
  is_featured: true,
};
...
const FALLBACK_EVENT = {
  id: 'evt_wako_live',
  title: 'Wako Kungo Live · Tagus Drop',
  slug: 'wako-kungo-live-lapa71',
  description: 'A night of music, movement and connection. Artists. Community. Flow.',
  cover_image: null,
  ...
  member_benefit: 'Early entry · Community benefit',
  ...
  return {
    ...
    location: location
      ? {
          ...
          instagramUrl: location.instagram_url || null,
