...
clean_scripts = """    <script src="../js/translations.js"></script>
...
import re
new_port_content = re.sub(r'<script src="../js/translations\.js"></script>.*</body>\s*</html>', clean_scripts, port_content, flags=re.DOTALL)
if new_port_content != port_content:
    with open(portfolio_path, 'w', encoding='utf-8') as f:
        f.write(new_port_content)
    print("Fixed portfolio_anime_reality.html JS logic completely.")
else:
